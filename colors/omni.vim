...
if !exists("g:omni_termcolors")
  let g:omni_termcolors = 256
endif

if !exists("g:omni_terminal_italics")
  let g:omni_terminal_italics = 0
endif
...
function! omni#set_highlight(group, style)
...
if has("nvim")
  ...
  let g:terminal_color_background = '#191622'
  let g:terminal_color_foreground = '#e1e1e6'
elseif has('terminal')
